...
from .context_tool_editor_hotfix_v12 import ContextToolEditorWorkspaceView
...
def create_workspace_view(
    ...
    *,
    ...
    """Return the editor with expanded Batik colours and progress-aware AI workflows."""
