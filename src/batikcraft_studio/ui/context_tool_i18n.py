...
_TRANSLATIONS = {
    "id": {
        ...
        "context.click_again": (
            "Klik ikon alat yang sama untuk menyembunyikan atau menampilkan opsi ini."
        ),
        "context.eraser_destructive": (
            "Penghapus mengurangi piksel objek yang disentuh dan tidak membuat objek "
            "penutup baru."
        ),
        "context.eraser_object_required": (
            "Klik dan seret langsung pada objek yang ingin dihapus sebagian."
        ),
    ...
    "en": {
        ...
        "context.eraser_destructive": (
            "The eraser removes pixels from the touched object instead of creating an "
            "overlay object."
        ),
